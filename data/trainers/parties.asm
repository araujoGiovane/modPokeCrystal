...
FalknerGroup:
	...
	db  7, FARFETCH_D, GUST, SWIFT, REST, SNORE
...
BugsyGroup:
	...
	db 14, BUTTERFREE, PSYCHIC_M, HIDDEN_POWER, STUN_SPORE, POISONPOWDER
...
PryceGroup:
	...
	db 35, PILOSWINE, EARTHQUAKE, ICY_WIND, ANCIENTPOWER, REST
	db -1 ; end
...
ChuckGroup:
	...
	db 30, POLIWRATH, DYNAMICPUNCH, MIND_READER, SURF, EARTHQUAKE
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGONBREATH, LIGHT_SCREEN, SURF
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGONBREATH, DOUBLE_TEAM, THUNDERBOLT
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGONBREATH, LIGHT_SCREEN, ICE_BEAM
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGONBREATH, DOUBLE_TEAM, FLAMETHROWER
	db 39, DRATINI, THUNDER_WAVE, DOUBLE_TEAM, LIGHT_SCREEN, DRAGON_RAGE
	db 40, KINGDRA, SURF, ICE_BEAM, DRAGONBREATH, REST
	db -1 ; end
...
Rival1Group:
	...
	db 18, BAYLEEF, GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
...
WillGroup:
	...
	db 49, SLOWKING, REST, AMNESIA, PSYCHIC_M, ICE_BEAM
	db 49, GIRAFARIG, PSYCHIC_M, STOMP, SHADOW_BALL, THUNDERBOLT
	db 48, JYNX, LOVELY_KISS, ICY_WIND, PSYCHIC_M, ICE_BEAM
	db 48, HYPNO, PSYCHIC_M, HYPNOSIS, NIGHTMARE, SHADOW_BALL
	db 50, NATU, DRILL_PECK, PSYCHIC_M, CONFUSE_RAY, DOUBLE_TEAM
	db -1 ; end
...
BrockGroup:
	...
	db 60, SUDOWOODO, ROCK_SLIDE, EARTHQUAKE, SANDSTORM, SELFDESTRUCT
	db 60, KABUTOPS, ANCIENTPOWER, SANDSTORM, BLIZZARD, PROTECT
	db 60, AERODACTYL, ANCIENTPOWER, WING_ATTACK, STEEL_WING, SANDSTORM
	db 60, SHUCKLE, ROLLOUT, SANDSTORM, DEFENSE_CURL, REST
	db 61, TYRANITAR, ANCIENTPOWER, CRUNCH, REST, SLEEP_TALK
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 59, CORSOLA, SURF, ANCIENTPOWER, MIRROR_COAT, RECOVER
	db 59, GOLDUCK, SURF, LIGHT_SCREEN, ICE_BEAM, REST
	db 59, MANTINE, SURF, ICE_BEAM, CONFUSE_RAY, AGILITY
	db 59, QUAGSIRE, SURF, EARTHQUAKE, CURSE, ANCIENTPOWER
...
JanineGroup:
	...
	db 59, VENOMOTH, TOXIC, SLUDGE_BOMB, PSYCHIC_M, DOUBLE_TEAM
	db -1 ; end
...
SabrinaGroup:
	...
	db 56, WOBBUFFET, COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 56, EXEGGUTOR, SYNTHESIS, PSYCHIC_M, SLEEP_POWDER, NIGHTMARE
	db 56, UNOWN, HIDDEN_POWER, NO_MOVE, NO_MOVE, NO_MOVE
	db 56, MR__MIME, PSYCHIC_M, THUNDERBOLT, BARRIER, BATON_PASS
	db 56, EXEGGUTOR, PSYCHIC_M, SLEEP_POWDER, ANCIENTPOWER, DREAM_EATER
	db 57, ALAKAZAM, PSYCHIC_M, RECOVER, THUNDERPUNCH, ICE_PUNCH
    db -1 ; end
...
Rival2Group:
	...
	db 43, ALAKAZAM, PSYCHIC_M, RECOVER, FIRE_PUNCH, ICE_PUNCH
	...
	db 43, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 43, ALAKAZAM, PSYCHIC_M, RECOVER, FIRE_PUNCH, ICE_PUNCH
	db 45, TYPHLOSION, SMOKESCREEN, EARTHQUAKE, THUNDERPUNCH, FIRE_BLAST
	db -1 ; end
	...
	db 51, ALAKAZAM, PSYCHIC_M, RECOVER, FIRE_PUNCH, REFLECT
	...
	db 54, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 51, ALAKAZAM, PSYCHIC_M, RECOVER, FIRE_PUNCH, REFLECT
	db 55, TYPHLOSION, SMOKESCREEN, EARTHQUAKE, THUNDERPUNCH, FIRE_BLAST
	db -1 ; end
...
BlaineGroup:
	...
	db 61, MAGMAR, CONFUSE_RAY, FLAMETHROWER, CROSS_CHOP, THUNDERPUNCH
	db 61, ARCANINE, FLAMETHROWER, CRUNCH, SLEEP_TALK, REST
	db 61, NINETALES, FLAMETHROWER, CONFUSE_RAY, HYPNOSIS, HIDDEN_POWER
...
RedGroup:
	...
	db 73, ESPEON, MUD_SLAP, PSYCHIC_M, CHARM, MORNING_SUN
...
BlueGroup:
	...
	db 63, EXEGGUTOR, SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, DOUBLE_TEAM
	db 63, ARCANINE, FLAMETHROWER, EXTREMESPEED, HIDDEN_POWER, ATTRACT
	db 63, GYARADOS, FLAIL, SURF, ICY_WIND, HIDDEN_POWER
	db 63, ALAKAZAM, PSYCHIC_M, RECOVER, DOUBLE_TEAM, ICE_PUNCH
	db 63, PIDGEOT, WING_ATTACK, STEEL_WING, MUD_SLAP, HYPER_BEAM
	db 63, RHYDON, EARTHQUAKE, ROCK_SLIDE, ICY_WIND, HIDDEN_POWER
	db -1 ; end
