...
MortyGroup:
	...
	db 23, MISDREAVUS, SHADOW_BALL, PSYCHIC, THUNDERBOLT, DESTINY_BOND
...
JasmineGroup:
	...
	db 30, MAGNETITE, THUNDERBOLT, THUNDER_WAVE, FLASH, HIDDEN_POWER
	db 30, MAGNETITE, FLASH, THUNDER, RAIN_DANCE, DOUBLE_TEAM
...
ChuckGroup:
	...
	db 27, PRIMEAPE, KARATE_CHOP, SWAGGER, PSY_UP, ROCK_SLIDE
