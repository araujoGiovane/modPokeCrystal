...
FalknerGroup:
	...
	db  7, DODUO, PECK, FLAIL, STEEL_WING, MUD_SLAP
	db  7, FARFETCHD, GUST, SWIFT, REST, SNORE
	db  7, GLIGAR, POISON_STING, METAL_CLAW, SANDSTORM, DETECT
	db  7, SPEAROW, PECK, HIDDEN_POWER, QUICK_ATTACK, STEEL_WING
	db  7, HOOTHOOT, TACKLE, STEEL_WING, GROWL, WHIRLWIND
	db  9, PIDGEY, GUST, MUD_SLAP, STEEL_WING, HIDDEN_POWER
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, SMEARGLE, SPORE, BATON_PASS, AGILITY, ENCORE
	db 18, FURRET, SLEEP_TALK, REST, REVERSAL, HEADBUTT
	db 18, TOGETIC, ATTRACT, CHARM, METRONOME, FLAMETHROWER
	db 18, STANTLER, EARTHQUAKE, HEADBUTT, REFLECT, HYPNOSIS
	db 18, AIPOM, COUNTER, ATTRACT, ICE_PUNCH, STRENGTH
	db 20, MILTANK, ROLLOUT, ATTRACT, MILK_DRINK, STOMP
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 14, PINSIR, FURY_CUTTER, HEADBUTT, REST, SNORE
	db 14, BUTTERFREE, PSYCHIC, HIDDEN_POWER, STUN_SPORE, POISON_POWDER
	db 14, LEDYBA, LIGHT_SCREEN, THIEF, THUNDERPUNCH, ICE_PUNCH
	db 14, PINECO, SELFDESTRUCT, REFLECT, HEADBUTT, ROLLOUT
	db 14, YANMA, LEECH_LIFE, FLASH, HEADBUTT, FORESIGHT
	db 16, SCYTHER, FURY_CUTTER, REVERSAL, STEEL_WING, HIDDEN_POWER
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 24, HAUNTER, HYPNOSIS, SHADOW_BALL, NIGHTMARE, THUNDERBOLT
	db 23, GASTLY, PERISH_SONG, MEAN_LOOK, DOUBLE_TEAM, SWAGGER
	db 23, MISDREAVUS, SHADOW_BALL, PSYCHIC_M, THUNDERBOLT, DESTINY_BOND
	db 23, MISDREAVUS, CONFUSE_RAY, DESTINY_BOND, SHADOW_BALL, MEAN_LOOK
	db 23, MISDREAVUS, MEAN_LOOK, CONFUSE_RAY, THUNDERBOLT, SHADOW_BALL
...
PryceGroup:
	...
	db 32, DEWGONG, ICE_BEAM, SURF, DOUBLE_TEAM, REST
	db 32, DELIBIRD, ICE_BEAM, ICY_WIND, REST, HIDDEN_POWER
	db 32, LAPRAS, SURF, ICE_BEAM, REST, CONFUSE_RAY
	db 32, CLOYSTER, SURF, ICE_BEAM, REST, SLEEP_TALK
	db 33, SNEASEL, BLIZZARD, DOUBLE_TEAM, THIEF, STRENGTH
	db 35, PILOSWINE, EARTHQUAKE, ICY_WIND, ANCIENT_POWER, REST
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 30, SKARMORY, DRILL_PECK, STEEL_WING, SWAGGER, SANDSTORM
	db 30, MAGNEMITE, THUNDERBOLT, THUNDER_WAVE, FLASH, HIDDEN_POWER
	db 30, SKARMORY, DRILL_PECK, STEEL_WING, SAND_ATTACK, SANDSTORM
	db 30, SKARMORY, SANDSTORM, PROTECT, STEEL_WING, DRILL_PECK
	db 30, MAGNEMITE, FLASH, THUNDER, RAIN_DANCE, DOUBLE_TEAM
	db 33, STEELIX, IRON_TAIL, EARTHQUAKE, ROCK_SLIDE, SANDSTORM
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
  	db 27, PRIMEAPE, KARATE_CHOP, THUNDER, COUNTER, STRENGTH
	db 27, HERACROSS, DOUBLE_TEAM, ENDURE, FLAIL, HIDDEN_POWER
	db 27, PRIMEAPE, KARATE_CHOP, SWAGGER, PSYCH_UP, ROCK_SLIDE
	db 27, HERACROSS, COUNTER, ENDURE, FLAIL, EARTHQUAKE
	db 27, HERACROSS, HIDDEN_POWER, COUNTER, HORN_ATTACK, EARTHQUAKE
	db 30, POLIWRATH, DYNAMIC_PUNCH, MIND_READER, SURF, EARTHQUAKE
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGON_BREATH, LIGHT_SCREEN, SURF
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGON_BREATH, DOUBLE_TEAM, THUNDERBOLT
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGON_BREATH, LIGHT_SCREEN, ICE_BEAM
	db 37, DRAGONAIR, THUNDER_WAVE, DRAGON_BREATH, DOUBLE_TEAM, FLAMETHROWER
	db 39, DRATINI, THUNDER_WAVE, DOUBLE_TEAM, LIGHT_SCREEN, DRAGON_RAGE
	db 40, KINGDRA, SURF, ICE_BEAM, DRAGON_BREATH, REST
	db -1 ; end
...
Rival1Group:
	...
	db 18, BAYLEEF, GROWL, REFLECT, RAZOR_LEAF, POISON_POWDER
	db -1 ; end
	...
	db 12, GASTLY, HYPNOSIS, LICK, SPITE, NO_MOVE
	db 14, ZUBAT, LEECH_LIFE, SUPERSONIC, BITE, NO_MOVE
	db 18, QUILAVA, LEER, TACKLE, SMOKESCREEN, EMBER
	db -1 ; end
	...
	db 12, GASTLY, HYPNOSIS, LICK, SPITE, NO_MOVE
	db 14, ZUBAT, LEECH_LIFE, SUPERSONIC, BITE, NO_MOVE
	db 18, CROCONAW, LEER, SCRATCH, RAGE, WATER_GUN
	db -1 ; end
	...
	db 22, BAYLEEF, GROWL, REFLECT, RAZOR_LEAF, POISON_POWDER
	db -1 ; end
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, GOLBAT, ATTRACT, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, MAGNEMITE, HIDDEN_POWER, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 31, HAUNTER, CONFUSE_RAY, HYPNOSIS, MEAN_LOOK, CURSE
	db 32, SNEASEL, SHADOW_BALL, SCREECH, ICY_WIND, IRON_TAIL
	db 36, MEGANIUM, REFLECT, RAZOR_LEAF, POISON_POWDER, BODY_SLAM
	db -1 ; end
	...
	db 31, HAUNTER, CONFUSE_RAY, HYPNOSIS, MEAN_LOOK, CURSE
	db 32, SNEASEL, SHADOW_BALL, SCREECH, ICY_WIND, IRON_TAIL
	db 36, TYPHLOSION, SMOKESCREEN, HEADBUTT, LEER, FLAME_WHEEL
	db -1 ; end
	...
	db 31, HAUNTER, CONFUSE_RAY, HYPNOSIS, MEAN_LOOK, CURSE
	db 32, SNEASEL, SHADOW_BALL, SCREECH, ICY_WIND, IRON_TAIL
	db 36, FERALIGATR, SURF, ICE_PUNCH, SCARY_FACE, HEADBUTT
	db -1 ; end
	...
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 34, SNEASEL, SHADOW_BALL, SCREECH, ICY_WIND, IRON_TAIL
	db 36, GOLBAT, ATTRACT, BITE, CONFUSE_RAY, WING_ATTACK
	db 35, MAGNETON, THUNDERBOLT, HIDDEN_POWER, THUNDER_WAVE, TRI_ATTACK
	db 35, HAUNTER, CONFUSE_RAY, HYPNOSIS, MEAN_LOOK, CURSE
	db 35, KADABRA, PSYBEAM, RECOVER, FIRE_PUNCH, ICE_PUNCH
	db 38, MEGANIUM, REFLECT, RAZOR_LEAF, POISON_POWDER, BODY_SLAM
	db -1 ; end
	...
	db 35, HAUNTER, CONFUSE_RAY, HYPNOSIS, MEAN_LOOK, CURSE
	db 35, KADABRA, PSYBEAM, RECOVER, FIRE_PUNCH, ICE_PUNCH
	db 38, TYPHLOSION, SMOKESCREEN, EARTHQUAKE, THUNDERPUNCH, FIRE_BLAST
	db -1 ; end
	...
	db 35, HAUNTER, CONFUSE_RAY, HYPNOSIS, MEAN_LOOK, CURSE
	db 35, KADABRA, PSYBEAM, RECOVER, FIRE_PUNCH, ICE_PUNCH
	db 38, FERALIGATR, SURF, ICE_PUNCH, SCARY_FACE, EARTHQUAKE
	db -1 ; end
...
WillGroup:
	...
	db 49, SLOWKING, SWAGGER, SURF, ICE_BEAM, EARTHQUAKE
	db 49, SLOWKING, REST, AMNESIA, PSYCHIC, ICE_BEAM
	db 49, GIRAFARIG, PSYCHIC, STOMP, SHADOW_BALL, THUNDERBOLT
	db 48, JYNX, LOVELY_KISS, ICY_WIND, PSYCHIC, ICE_BEAM
	db 48, HYPNO, PSYCHIC, HYPNOSIS, NIGHTMARE, SHADOW_BALL
	db 50, NATU, DRILL_PECK, PSYCHIC, CONFUSE_RAY, DOUBLE_TEAM
	db -1 ; end
...
BrunoGroup:
	...
	db 50, HITMONTOP, HI_JUMP_KICK, SLEEP_TALK, REST, MUD_SLAP
	db 50, HITMONTOP, MACH_PUNCH, HIDDEN_POWER, CURSE, DOUBLE_TEAM
	db 51, HITMONTOP, HI_JUMP_KICK, HEADBUTT, CURSE, MUD_SLAP
	db 51, HITMONCHAN, MACH_PUNCH, HI_JUMP_KICK, CURSE, MUD_SLAP
	db 51, HITMONLEE, HI_JUMP_KICK, HIDDEN_POWER, MUD_SLAP, ATTRACT
	db 52, MACHAMP, CROSS_CHOP, VITAL_THROW, EARTHQUAKE, CURSE
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 52, UMBREON, CHARM, TOXIC, MOONLIGHT, PURSUIT
	db 51, SNEASEL, SHADOW_BALL, ICE_BEAM, SCREECH, DOUBLE_TEAM
	db 51, MURKROW, DRILL_PECK, FAINT_ATTACK, STEEL_WING, MUD_SLAP
	db 52, UMBREON, CONFUSE_RAY, MEAN_LOOK, TOXIC, MOONLIGHT
	db 51, MURKROW, FAINT_ATTACK, DRILL_PECK, ICY_WIND, HIDDEN_POWER
	db 53, HOUNDOOM, CRUNCH, FLAMETHROWER, SOLARBEAM, SUNNY_DAY
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 49, TENTACRUEL, MIRROR_COAT, SURF, ICE_BEAM, GIGA_DRAIN
	db 49, NIDOKING, SHADOW_BALL, EARTHQUAKE, AMNESIA, THUNDERBOLT
	db 50, ARIADOS, AGILITY, DOUBLE_TEAM, BATON_PASS, SLUDGE_BOMB
	db 50, MUK, SLUDGE_BOMB, GIGA_DRAIN, ACID_ARMOR, MINIMIZE
	db 50, WEEZING, SLUDGE_BOMB, EXPLOSION, PAIN_SPLIT, DESTINY_BOND
	db 51, CROBAT, WING_ATTACK, TOXIC, CONFUSE_RAY, DOUBLE_TEAM
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 53, KINGDRA, ICY_WIND, HYDRO_PUMP, REST, DRAGONBREATH
	db 54, DRAGONAIR, AGILITY, THUNDERBOLT, ICE_BEAM, DOUBLE_TEAM
	db 53, KINGDRA, SURF, DRAGONBREATH, REST, DOUBLE_TEAM
	db 53, KINGDRA, SMOKESCREEN, SURF, ICE_BEAM, DRAGONBREATH
	db 54, DRAGONAIR, THUNDER_WAVE, LIGHT_SCREEN, THUNDERBOLT, ICE_BEAM
	db 55, DRAGONITE, OUTRAGE, THUNDERBOLT, FLAMETHROWER, SURF
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 60, GOLEM, EARTHQUAKE, ROCK_SLIDE, EXPLOSION, HIDDEN_POWER
	db 60, SUDOWOODO, ROCK_SLIDE, EARTHQUAKE, SANDSTORM, SELF_DESTRUCT
	db 60, KABUTOPS, ANCIENT_POWER, SANDSTORM, BLIZZARD, PROTECT
	db 60, AERODACTYL, ANCIENT_POWER, WING_ATTACK, STEEL_WING, SANDSTORM
	db 60, SHUCKLE, ROLLOUT, SANDSTORM, DEFENSE_CURL, REST
	db 61, TYRANITAR, ANCIENT_POWER, CRUNCH, REST, SLEEP_TALK
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 59, CORSOLA, SURF, ANCIENT_POWER, MIRROR_COAT, RECOVER
	db 59, GOLDUCK, SURF, LIGHT_SCREEN, ICE_BEAM, REST
	db 59, MANTINE, SURF, ICE_BEAM, CONFUSE_RAY, AGILITY
	db 59, QUAGSIRE, SURF, EARTHQUAKE, CURSE, ANCIENT_POWER
	db 59, OMASTAR, SURF, ICE_BEAM, DOUBLE_TEAM, REST
	db 60, STARMIE, SURF, RECOVER, THUNDERBOLT, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 55, RAICHU, SWEET_KISS, DOUBLE_TEAM, THUNDERBOLT, CHARM
	db 55, AMPHAROS, THUNDERBOLT, REFLECT, REST, HIDDEN_POWER
	db 55, LANTURN, SURF, THUNDERBOLT, ICE_BEAM, CONFUSE_RAY
	db 55, LANTURN, SURF, THUNDERBOLT, ICE_BEAM, RAIN_DANCE
	db 55, ELECTRODE, THUNDERBOLT, DOUBLE_TEAM, HIDDEN_POWER, EXPLOSION
	db 56, ELECTABUZZ, THUNDERBOLT, CROSS_CHOP, ICE_PUNCH, DOUBLE_TEAM
	db -1 ; end
...
ErikaGroup:
	...
	db 57, JUMPLUFF, GIGA_DRAIN, SLEEP_POWDER, LEECH_SEED, ENCORE
	db 57, SUNFLORA, GIGA_DRAIN, SLUDGE_BOMB, SYNTHESIS, HIDDEN_POWER
	db 57, TANGELA, GIGA_DRAIN, SLUDGE_BOMB, AMNESIA, REST
	db 57, PARASECT, SPORE, GIGA_DRAIN, SLUDGE_BOMB, LIGHT_SCREEN
	db 58, VICTREEBEL, SWORDS_DANCE, SLUDGE_BOMB, GIGA_DRAIN, SLEEP_POWDER
	db 58, BELLOSSOM, SLEEP_POWDER, GIGA_DRAIN, SYNTHESIS, SLUDGE_BOMB	
	db -1 ; end
...
JanineGroup:
	...
	db 58, QWILFISH, HYDRO_PUMP, TOXIC, ICE_BEAM, SPIKES
	db 58, QWILFISH, SURF, ICE_BEAM, SLUDGE_BOMB, SPIKES
	db 58, ARBOK, SLUDGE_BOMB, EARTHQUAKE, CRUNCH, GLARE
	db 58, BEEDRILL, SLUDGE_BOMB, DOUBLE_TEAM, AGILITY, HIDDEN_POWER
	db 58, NIDOQUEEN, HIDDEN_POWER, EARTHQUAKE, TOXIC, SURF
	db 59, VENOMOTH, TOXIC, SLUDGE_BOMB, PSYCHIC, DOUBLE_TEAM
	db -1 ; end
...
SabrinaGroup:
	...
	db 56, WOBBUFFET, COUNTER, MIRROR_COAT, SAFE_GUARD, DESTINY_BOND
	db 56, EXEGUTOR, SYNTHESIS, PSYCHIC, SLEEP_POWDER, NIGHTMARE
	db 56, UNOWN, HIDDEN_POWER, NO_MOVE, NO_MOVE, NO_MOVE
	db 56, MR_MIME, PSYCHIC, THUNDERBOLT, BARRIER, BATON_PASS
	db 56, EXECUTOR, PSYCHIC, SLEEP_POWDER, ANCIENT_POWER, DREAM_EATER
	db 57, ALAKAZAM, PSYCHIC, RECOVER, THUNDER_PUNCH, ICE_PUNCH
    db -1 ; end
...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_MOVES
	db 41, SNEASEL, SHADOW_BALL, SCREECH, ICY_WIND, IRON_TAIL
	db 42, GOLBAT, ATTRACT, BITE, CONFUSE_RAY, WING_ATTACK
	db 41, MAGNETON, THUNDERBOLT, HIDDEN_POWER, THUNDER_WAVE, TRI_ATTACK
	db 43, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 43, ALAKAZAM, PSYCHIC, RECOVER, FIRE_PUNCH, ICE_PUNCH
	db 45, MEGANIUM, RAZOR_LEAF, REFLECT, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 43, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 43, ALAKAZAM, PSYCHIC, RECOVER, FIRE_PUNCH, ICE_PUNCH
	db 45, TYPHLOSION, SMOKESCREEN, EARTHQUAKE, THUNDER_PUNCH, FIRE_BLAST
	db -1 ; end
	...
	db 43, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 43, ALAKAZAM, PSYCHIC, RECOVER, FIRE_PUNCH, ICE_PUNCH
	db 45, FERALIGATR, SURF, ICE_PUNCH, SCARY_FACE, EARTHQUAKE
	db -1 ; end
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 52, SNEASEL, SHADOW_BALL, SCREECH, ICY_WIND, IRON_TAIL
	db 54, CROBAT, ATTRACT, BITE, CONFUSE_RAY, WING_ATTACK
	db 53, MAGNETON, THUNDERBOLT, HIDDEN_POWER, THUNDER_WAVE, TRI_ATTACK
	db 54, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 51, ALAKAZAM, PSYCHIC, RECOVER, FIRE_PUNCH, REFLECT
	db 55, MEGANIUM, GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFE_GUARD
	db -1 ; end
	...
	db 54, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 51, ALAKAZAM, PSYCHIC, RECOVER, FIRE_PUNCH, REFLECT
	db 55, TYPHLOSION, SMOKESCREEN, EARTHQUAKE, THUNDER_PUNCH, FIRE_BLAST
	db -1 ; end
	...
	db 54, GENGAR, MEAN_LOOK, CURSE, HYPNOSIS, CONFUSE_RAY
	db 51, ALAKAZAM, PSYCHIC, RECOVER, FIRE_PUNCH, REFLECT
	db 55, FERALIGATR, SURF, ICE_PUNCH, SCARY_FACE, EARTHQUAKE
	db -1 ; end
...
BlaineGroup:
	...
	db 61, MAGCARGO, FLAMETHROWER, ROCK_SLIDE, AMNESIA, HIDDEN_POWER
	db 61, MAGCARGO, ACID_ARMOR, FLAMETHROWER, REST, AMNESIA
	db 61, MAGMAR, CONFUSE_RAY, FLAMETHROWER, CROSS_CHOP, THUNDER_PUNCH
	db 61, ARCANINE, FLAMETHROWER, CRUNCH, SLEEP_TALK, REST
	db 61, NINETAILS, FLAMETHROWER, CONFUSE_RAY, HYPNOSIS, HIDDEN_POWER
	db 62, RAPIDASH, HYPNOSIS, FLAMETHROWER, HIDDEN_POWER, DOUBLE_TEAM
	db -1 ; end
...
RedGroup:
    ...
    db 77, BLASTOISE, SURF, RAIN_DANCE, BLIZZARD, MIRROR_COAT
    db 77, CHARIZARD, FLAMETHROWER, WING_ATTACK, EARTHQUAKE, BELLY_DRUM
    db 77, VENUSAUR, GIGA_DRAIN, SYNTHESIS, SLEEP_POWDER, LEECH_SEED
    db 73, ESPEON, MUD_SLAP, PSYCHIC, CHARM, MORNING_SUN
    db 75, SNORLAX, CURSE, REST, EARTHQUAKE, SNORE
    db 81, PIKACHU, THUNDERBOLT, SURF, DOUBLE_TEAM, HEADBUTT
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 63, EXEGUTOR, SLEEP_POWDER, GIGA_DRAIN, PSYCHIC, DOUBLE_TEAM
	db 63, ARCANINE, FLAMETHROWER, EXTREME_SPEED, HIDDEN_POWER, ATTRACT
	db 63, GYARADOS, FLAIL, SURF, ICY_WIND, HIDDEN_POWER
	db 63, ALAKAZAM, PSYCHIC, RECOVER, DOUBLE_TEAM, ICE_PUNCH
	db 63, PIDGEOTTO, WING_ATTACK, STEEL_WING, MUD_SLAP, HYPER_BEAM
	db 63, RYDON, EARTHQUAKE, ROCK_SLIDE, ICY_WIND, HIDDEN_POWER
	db -1 ; end
